...
public class MedianInSortedArrays {
  /**
   * Thoughts: if A[i] is the median, then B[j]<A[i]<B[j+1]
   * The important thing is to control that what is the relationship of j and i
   * The function of get(A, i) is great. 
   * @param A
   * @param B
   * @return
   */
